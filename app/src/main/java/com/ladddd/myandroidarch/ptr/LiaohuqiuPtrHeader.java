package com.ladddd.myandroidarch.ptr;
...
public class LiaohuqiuPtrHeader extends FrameLayout implements PtrUIHandler {
    ...
    public LiaohuqiuPtrHeader(Context context) {
        super(context);
        initViews(null);
    }

    public LiaohuqiuPtrHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public LiaohuqiuPtrHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        View header = LayoutInflater.from(getContext()).inflate(R.layout.liaohuqiu_ptr_head, this);
